...
var sGameFishImgUrl = location.origin + "/img/business/game/fishing/";
...
[
	...
	{id:"mainbg", size:456, src: sGameFishImgUrl + "images/game_bg_2_hd.jpg?"+Math.random()},
	{id:"bottom", size:50, src: sGameFishImgUrl + "images/bottom.png?"+Math.random()},
	{id:"fish1", size:6, src: sGameFishImgUrl + "images/fish1.png?"+Math.random()},
	{id:"fish2", size:16, src: sGameFishImgUrl + "images/fish2.png?"+Math.random()},
	{id:"fish3", size:11, src: sGameFishImgUrl + "images/fish3.png?"+Math.random()},
	{id:"fish4", size:15, src: sGameFishImgUrl + "images/fish4.png?"+Math.random()},
	{id:"fish5", size:43, src: sGameFishImgUrl + "images/fish5.png?"+Math.random()},
	{id:"fish6", size:45, src: sGameFishImgUrl + "images/fish6.png?"+Math.random()},
	{id:"fish7", size:80, src: sGameFishImgUrl + "images/fish7.png?"+Math.random()},
	{id:"fish8", size:100, src: sGameFishImgUrl + "images/fish8.png?"+Math.random()},
	{id:"fish9", size:104, src: sGameFishImgUrl + "images/fish9.png?"+Math.random()},
	{id:"fish10", size:121, src: sGameFishImgUrl + "images/fish10.png?"+Math.random()},
	{id:"shark1", size:287, src: sGameFishImgUrl + "images/shark1.png?"+Math.random()},
	{id:"shark2", size:382, src: sGameFishImgUrl + "images/shark2.png?"+Math.random()},
	{id:"cannon1", size:11, src: sGameFishImgUrl + "images/cannon1.png?"+Math.random()},
	{id:"cannon2", size:11, src: sGameFishImgUrl + "images/cannon2.png?"+Math.random()},
	{id:"cannon3", size:11, src: sGameFishImgUrl + "images/cannon3.png?"+Math.random()},
	{id:"cannon4", size:13, src: sGameFishImgUrl + "images/cannon4.png?"+Math.random()},
	{id:"cannon5", size:13, src: sGameFishImgUrl + "images/cannon5.png?"+Math.random()},
	{id:"cannon6", size:15, src: sGameFishImgUrl + "images/cannon6.png?"+Math.random()},
	{id:"cannon7", size:17, src: sGameFishImgUrl + "images/cannon7.png?"+Math.random()},
	{id:"bullet", size:8, src: sGameFishImgUrl + "images/bullet.png?"+Math.random()},
	{id:"web", size:93, src: sGameFishImgUrl + "images/web.png?"+Math.random()},
	{id:"numBlack", size:1, src: sGameFishImgUrl + "images/number_black.png?"+Math.random()},
	{id:"coinAni1", size:19, src: sGameFishImgUrl + "images/coinAni1.png?"+Math.random()},
	{id:"coinAni2", size:22, src: sGameFishImgUrl + "images/coinAni2.png?"+Math.random()},
	{id:"coinText", size:16, src: sGameFishImgUrl + "images/coinText.png?"+Math.random()}
];
