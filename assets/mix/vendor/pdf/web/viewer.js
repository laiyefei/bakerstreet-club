...
function configure(PDFJS) {
  ...
  PDFJS.workerSrc = '../../../../mix/vendor/pdf/build/pdf.worker.js';
...
var sFilePath = document.getElementById("hfRootPath").value
+ document.getElementById("hfFilePath").value
var DEFAULT_URL = sFilePath || '../../../../mix/vendor/pdf/web/compressed.tracemonkey-pldi-09.pdf';
;
var pdfjsWebApp;
{
